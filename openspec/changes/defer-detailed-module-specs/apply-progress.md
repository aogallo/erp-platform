...
| 1.4 | Created `openspec/changes/defer-detailed-module-specs/specs/hr/spec.md` with ADDED requirements and Given/When/Then scenarios. | Reviewed against `docs/bounded-context.md`, `AGENTS.md`, and Accounting payable handoff boundaries. |
