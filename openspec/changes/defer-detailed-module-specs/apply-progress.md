...
| Field | Value |
|-------|-------|
| Work unit | Accounting + Banking detailed specs |
| PR boundary | Specification-only slice for Accounting and Banking; prior Inventory/Purchasing evidence preserved |
